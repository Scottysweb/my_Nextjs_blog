...
export default function Navigation() {
    ...
    const navItems = [
        { name: "Home", href: "/" },
        { name: "Contact", href: "/app/contact/page.tsx" },
        { name: "Services", href:"#" },
        { name: "Feedback", href: "#" },
    ];
    ...
    return (
        <div>
            <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-blue-200 font-bold bg-opacity-90 sticky top-3 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]">
                <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
                    <Link
                        href="/"
                        className="bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text text-2xl"
                    >
                        Scottys NextJS Project
                    </Link>
                    ...
                    <div className="hidden lg:block">
                        <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                            {navItems.map((item, index) => (
                                <li
                                    key={index}
                                    className="flex items-center p-1 text-lg gap-x-2 text-slate-600 hover:text-white"
                                >
